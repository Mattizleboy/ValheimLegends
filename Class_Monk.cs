        ...
        public static bool PlayerIsUnarmed
{
    get
    {
        ...
        if (p.GetCurrentWeapon() != null)
        {
            ...
            // Check if both hands are unarmed or equipped with fist weapons
            if ((leftItemData != null && (leftItemData.m_name.ToLower() == "unarmed" || leftItemData.m_itemType == ItemDrop.ItemData.ItemType.Hands)) &&
                (rightItemData != null && (rightItemData.m_name.ToLower() == "unarmed" || rightItemData.m_itemType == ItemDrop.ItemData.ItemType.Hands)))
            {
                return true; // Player is unarmed or equipped with fists
            }
        }
        return false;
    }
